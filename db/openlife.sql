...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-11-2015 a las 20:49:29
...
CREATE TABLE IF NOT EXISTS `beneficiary` (
  ...
  KEY `fkProductByClient_idx` (`ProductID`)
...
CREATE TABLE IF NOT EXISTS `charge` (
  ...
  KEY `fk_Charge_Method1_idx` (`MethodID`)
...
CREATE TABLE IF NOT EXISTS `client` (
  ...
  UNIQUE KEY `Ident_UNIQUE` (`Ident`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=14313 ;
...
ALTER TABLE `beneficiary`
  ADD CONSTRAINT `fkProductByClient` FOREIGN KEY (`ProductID`) REFERENCES `product` (`ProductID`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `charge`
  ...
  ADD CONSTRAINT `fkMethodID` FOREIGN KEY (`MethodID`) REFERENCES `method` (`MethodID`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `product`
--
ALTER TABLE `product`
  ADD CONSTRAINT `fkClient` FOREIGN KEY (`ClientID`) REFERENCES `client` (`ClientID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
